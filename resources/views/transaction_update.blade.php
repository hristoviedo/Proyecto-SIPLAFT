...
<div id="col_client" role="main" class="col-md-9 ml-sm-auto col-lg-10 px-5"> {{-- Inicio del main --}}
    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        ...
        <form class="border p-3 form" method="POST" action="/transaction.update/{{ $transactionData->id }}">
            @csrf
            <div class="form-group row">
                <div class="col-md-6 mb-3">
                    <label for="identity">Identidad</label>
                    <input name="identity" id="identity" value="{{ $transactionData->identity }}" class="form-control" type="text" disabled required/>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="name">Nombre del Cliente</label>
                    <input name="name" id="name" value="{{ $transactionData->name }}" class="form-control text-uppercase" type="text" disabled required/>
                </div>
            </div>
            <div class="form-group row">
