...
Route::get('/col.simulation', 'ColController@col_simulation')->name('col.simulation'); // /simulation llama a la función 'simulation' de HomeController

Route::get('/col.client', 'ColController@col_client')->name('col.client'); // /home.col llama a la función 'home_colaborador' de HomeController

Route::get('/col.transaction', 'ColController@col_transaction')->name('col.transaction'); // /home.col llama a la función 'home_colaborador' de HomeController

Route::get('/col.report', 'ColController@col_report')->name('col.report'); // /report llama a la función 'report' de SupController

//-------------------------------------------------------------------------------------------------------------------------------------------

Route::get('/sup.client', 'SupController@sup_client')->name('sup.client'); // /home.sup llama a la función 'sup_client' de HomeController

Route::get('/sup.transaction', 'SupController@sup_transaction')->name('sup.transaction'); // /home.trans llama a la función 'sup_transaction' de HomeController
